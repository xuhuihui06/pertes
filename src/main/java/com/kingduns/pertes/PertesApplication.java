...
@MapperScan("com.kingduns.pertes.common.mapper")
public class PertesApplication {

	public static void main(String[] args) {
		SpringApplication.run(PertesApplication.class, args);
	}
